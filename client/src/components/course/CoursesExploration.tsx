...
export const CoursesExploration: React.FC<CoursesExplorationProps> = ({
  ...
  return (
    <section id="courses" className="py-24 px-10 lg:px-26 relative bg-surface scroll-mt-28">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-6xl font-headline font-bold tracking-tight text-primary">Technical <span className="text-accent">Certifications</span></h2>
                          ...
                          <div className="overflow-hidden">
                            <div className="pt-5 mt-5 border-t border-outline-variant/30 flex flex-col md:flex-row gap-4 items-start md:items-end justify-between">
                              ...
                              <Link
                                ...
                                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary-hover text-primary-foreground font-bold rounded-sm text-sm transition-all duration-200 hover:bg-foreground hover:-translate-y-1 active:scale-95 shrink-0"
                              >
                                Read More
                              </Link>
                            </div>
